        ...
        TextFormField(
          ...
          decoration: _inputDecoration("Confirm New Password", Icons.lock_outline).copyWith(
            suffixIcon: IconButton(
              ...
              icon: Icon(_obscureConfirmPassword ? Icons.visibility_off_outlined : Icons.visibility_outlined, color: secondaryTextColor),
            ),
          ),
          validator: (value) {
            if (value == null || value.isEmpty) return "Please confirm your password";
            if (value != _teacherPasswordController.text) return "Passwords do not match";
            return null;
          },
    ...
    return GestureDetector(
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          child: Center(
            child: widget.isLoading? const CircularProgressIndicator(color: Colors.white) : Text(
              widget.text,
